...
class BertForFullSequenceRelevance(PreTrainedBertModel):
    ...
    def forward(self, q_input_ids, p_input_ids, labels=None):

        q_sentence_output, q_pooled_output = self.bert(q_input_ids, output_all_encoded_layers=False)
        p_sentence_output, p_pooled_output = self.bert(p_input_ids, output_all_encoded_layers=False)
